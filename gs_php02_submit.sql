...
(5, '高橋ジュンコ', 'コンテンツメディア事業部', '記者', 'met', 'mid', 'dummy@dummy.co.jp', 'dummy@dummy.co.jp', '8039401747', '2022-12-15', '2022-12-15', 'メッセンジャー', NULL, '繊研新聞'),
(6, '北野亨子', '編集部', 'ライター', 'published', 'mid', 'dummy@dummy.co.jp', 'dummy@dummy.co.jp', '9012345678', '2022-12-16', '2022-12-16', '携帯電話', NULL, '日経MJ'),
...
(1, '新聞(全国紙)', '日経新聞', '株式会社日本経済新聞社'),
(3, '新聞(その他)', '繊研新聞', '株式会社繊研新聞社'),
(4, 'TV', 'テレビ東京', '株式会社テレビ東京'),
(5, 'paper_economical', '日経MJ', '株式会社日本経済新聞社'),
(6, 'tv', 'テレビ東京', '株式会社テレビ東京'),
(7, 'web', 'DIAMOND SIGNAL', '株式会社ダイヤモンド社'),
(8, 'magazine', '日経トレンディ', '株式会社 日経BP');
...
--
ALTER TABLE `media_table`
  MODIFY `media_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
